// // cert.js — สร้างใบรับรอง HTTPS เอง
// เพราะการสแกนบาร์โค้ดต้องใช้กล้อง ซึ่งเบราว์เซอร์บังคับว่าต้องเป็น HTTPS เท่านั้น ไฟล์นี้เลยสร้าง CA 
// (ใบรับรองแม่) ของตัวเองไว้ครั้งเดียว แล้วออกใบรับรองลูกให้เซิร์ฟเวอร์ทุกครั้งที่เปิดเครื่อง 
// (ครอบคลุมทุก IP ที่เครื่องมีในตอนนั้น) — เป็นเหตุผลที่ต้องติดตั้ง CA cert ใน iPad ครั้งเดียวตอนแรก แล้วใช้ได้ตลอดแม้ IP จะเปลี่ยน
