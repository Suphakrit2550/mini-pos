// สร้างบาร์โค้ดเส้น (Code128 — อ่านได้กับเครื่องยิงบาร์โค้ดทั่วไปทุกรุ่น ต่างจาก QR ที่ต้องใช้
// เครื่องสแกน 2 มิติโดยเฉพาะ) ให้สินค้าทุกชิ้นของบัญชีที่ระบุ แล้วจัดวางเป็นป้ายรูปสินค้า +
// บาร์โค้ด ลงกระดาษ A4 แยกไฟล์ PDF ตามหมวดหมู่ บันทึกลง ~/Downloads
//
