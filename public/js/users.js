// ไฟล์นี้ทำหน้าที่: หน้าจัดการผู้ใช้งาน (users.html) — เข้าถึงได้เฉพาะแอดมิน
// - แสดงรายชื่อผู้ใช้ทั้งหมด พร้อมสิทธิ์ (แอดมิน/พนักงาน) และสถานะเปิด/ปิดใช้งาน/ล็อกบัญชี
// - เพิ่มผู้ใช้ใหม่, สลับสิทธิ์, รีเซ็ตรหัสผ่าน, ปลดล็อกบัญชี, เปิด/ปิดใช้งาน, ลบผู้ใช้ (ต้องยืนยันรหัสผ่านตัวเอง)
